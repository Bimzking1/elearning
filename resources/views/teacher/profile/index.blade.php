        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="flex flex-col items-center justify-center bg-gray-100 p-6 rounded-lg shadow-md">
                <div class="w-36 h-36 xl:w-48 xl:h-48 rounded-full overflow-hidden bg-gray-200 mb-4">
                    ...
                    <img src="{{ $teacher && $teacher->user && $teacher->user->photo ? assetSubmissionPhoto($teacher->user->photo) : asset('images/default-avatar.png') }}" alt="Profile Photo" class="w-full h-full object-cover">
                </div>
