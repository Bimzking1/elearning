...
<div class="max-w-7xl mx-auto bg-white p-6 rounded-lg shadow-md">
    ...
    <div id="listView" class="presence-view hidden">
        @foreach($groupedSchedules as $classroomData)
            <div class="mb-8">
                <h3 class="text-2xl font-semibold text-gray-700 mb-4">{{ $classroomData['classroom']->name }}</h3>
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full table-auto border rounded-lg overflow-hidden shadow text-sm">
                        ...
                        <tbody class="text-gray-800">
                            @forelse($classroomData['schedules'] as $schedule)
                            ...
                            @empty
                                <tr>
                                    <td colspan="4" class="px-4 py-4 text-center text-gray-500">No schedules available.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
                        ...
                        <tbody class="divide-y divide-gray-200">
                            @foreach ($timeSlots as $time)
                                ...
                                <tr class="hover:bg-gray-50">
                                    ...
                                    @foreach ($days as $day)
                                        @php
                                            $matched = $schedules->first(function ($s) use ($classroom, $day, $start) {
