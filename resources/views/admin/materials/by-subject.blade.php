...
<div class="w-full mx-auto bg-white p-6 rounded-lg shadow-md">
    ...
    <div class="flex flex-col md:flex-row md:justify-between md:items-center gap-4 mb-4">
        <form method="GET" class="flex gap-2 w-full md:w-auto items-center">
            ...
            @if(request('search'))
                <a href="{{ request()->url() }}?classroom_id={{ $classroom->id }}&subject_id={{ $subject->id }}"
        ...
        <div class="flex gap-2">
            {{-- Card View --}}
            <a href="{{ route('admin.materials.bySubject', ['subject' => $subject->id]) }}?classroom_id={{ $classroom->id }}&view=card"
            ...
            {{-- List View --}}
            <a href="{{ route('admin.materials.bySubject', ['subject' => $subject->id]) }}?classroom_id={{ $classroom->id }}&view=list"
            class="px-4 py-2 rounded font-semibold transition
