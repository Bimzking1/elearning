...
<div class="w-full mx-auto bg-white p-6 rounded-lg shadow-md">
    <div class="flex flex-col md:flex-row md:justify-between md:items-center gap-4 mb-6">
        ...
        <a href="{{ route('admin.subjects.create') }}" class="w-full md:w-auto text-center bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 px-4 rounded-lg shadow-md transition">
            + Add New Subject
        </a>
    </div>
